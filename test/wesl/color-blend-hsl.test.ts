...
test('blendHue', async () => {
  const src = `
     import dkonasov__lygia::color::blend::hue::blendHue;
...
test('blendSaturation', async () => {
  const src = `
     import dkonasov__lygia::color::blend::saturation::blendSaturation;
...
test('blendColor', async () => {
  const src = `
     import dkonasov__lygia::color::blend::color::blendColor;
...
test('blendLuminosity', async () => {
  const src = `
     import dkonasov__lygia::color::blend::luminosity::blendLuminosity;
