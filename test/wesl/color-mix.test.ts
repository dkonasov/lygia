...
test('mixOklab', async () => {
  const src = `
     import dkonasov__lygia::color::mixOklab::mixOklab;
...
test('mixOklab4', async () => {
  const src = `
     import dkonasov__lygia::color::mixOklab::mixOklab4;
...
test('mixSpectral', async () => {
  const src = `
     import dkonasov__lygia::color::mixSpectral::mixSpectral;
...
test('mixSpectral4', async () => {
  const src = `
     import dkonasov__lygia::color::mixSpectral::mixSpectral4;
...
test('mixSpectral_linear_to_reflectance', async () => {
  const src = `
     import dkonasov__lygia::color::mixSpectral::mixSpectral_linear_to_reflectance;
...
test('mixSpectral_reflectance_to_xyz', async () => {
  const src = `
     import dkonasov__lygia::color::mixSpectral::{mixSpectral_linear_to_reflectance, mixSpectral_reflectance_to_xyz};
