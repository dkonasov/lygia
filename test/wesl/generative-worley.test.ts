...
test('worley2', async () => {
  const src = `
     import dkonasov__lygia::generative::worley::worley2;
...
test('worley22', async () => {
  const src = `
     import dkonasov__lygia::generative::worley::worley22;
...
test('worley3', async () => {
  const src = `
     import dkonasov__lygia::generative::worley::worley3;
...
test('worley32', async () => {
  const src = `
     import dkonasov__lygia::generative::worley::worley32;
