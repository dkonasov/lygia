...
test('blendHardLight3', async () => {
  const src = `
     import dkonasov__lygia::color::blend::hardLight::blendHardLight3;
...
test('blendOverlay3', async () => {
  const src = `
     import dkonasov__lygia::color::blend::overlay::blendOverlay3;
...
test('blendSoftLight3', async () => {
  const src = `
     import dkonasov__lygia::color::blend::softLight::blendSoftLight3;
...
test('blendVividLight3', async () => {
  const src = `
     import dkonasov__lygia::color::blend::vividLight::blendVividLight3;
...
test('blendPinLight3', async () => {
  const src = `
     import dkonasov__lygia::color::blend::pinLight::blendPinLight3;
...
test('blendLinearLight3', async () => {
  const src = `
     import dkonasov__lygia::color::blend::linearLight::blendLinearLight3;
...
test('blendHardMix3', async () => {
  const src = `
     import dkonasov__lygia::color::blend::hardMix::blendHardMix3;
...
test('blendGlow3', async () => {
  const src = `
     import dkonasov__lygia::color::blend::glow::blendGlow3;
...
test('blendOverlay - f32', async () => {
  const src = `
     import dkonasov__lygia::color::blend::overlay::blendOverlay;
...
test('blendSoftLight - f32', async () => {
  const src = `
     import dkonasov__lygia::color::blend::softLight::blendSoftLight;
...
test('blendHardLight - f32', async () => {
  const src = `
     import dkonasov__lygia::color::blend::hardLight::blendHardLight;
...
test('blendVividLight - f32', async () => {
  const src = `
     import dkonasov__lygia::color::blend::vividLight::blendVividLight;
...
test('blendPinLight - f32', async () => {
  const src = `
     import dkonasov__lygia::color::blend::pinLight::blendPinLight;
...
test('blendLinearLight - f32', async () => {
  const src = `
     import dkonasov__lygia::color::blend::linearLight::blendLinearLight;
...
test('blendHardMix - f32', async () => {
  const src = `
     import dkonasov__lygia::color::blend::hardMix::blendHardMix;
...
test('blendGlow - f32', async () => {
  const src = `
     import dkonasov__lygia::color::blend::glow::blendGlow;
