...
test('blendAdd3Opacity - opacity 0.5', async () => {
  const src = `
     import dkonasov__lygia::color::blend::add::blendAdd3Opacity;
...
test('blendMultiply3Opacity', async () => {
  const src = `
     import dkonasov__lygia::color::blend::multiply::blendMultiply3Opacity;
...
test('blendScreen3Opacity', async () => {
  const src = `
     import dkonasov__lygia::color::blend::screen::blendScreenWithOpacity3;
...
test('blendAverage3Opacity', async () => {
  const src = `
     import dkonasov__lygia::color::blend::average::blendAverage3Opacity;
...
test('blendLighten3Opacity', async () => {
  const src = `
     import dkonasov__lygia::color::blend::lighten::blendLighten3Opacity;
...
test('blendDarken3Opacity', async () => {
  const src = `
     import dkonasov__lygia::color::blend::darken::blendDarken3Opacity;
