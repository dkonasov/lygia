...
test('rotate2d - 90 degree rotation', async () => {
  const src = `
    ...
    import dkonasov__lygia::math::rotate2d::rotate2d;
...
test('rotate3d - rotation around axis', async () => {
  const src = `
    import dkonasov__lygia::math::consts::HALF_PI;
    import dkonasov__lygia::math::rotate3d::rotate3d;
    @compute @workgroup_size(1)
    fn foo() {
...
test('rotate3dX', async () => {
  const src = `
    import dkonasov__lygia::math::consts::HALF_PI;
    import dkonasov__lygia::math::rotate3dX::rotate3dX;
    @compute @workgroup_size(1)
    fn foo() {
...
test('rotate3dY', async () => {
  const src = `
    import dkonasov__lygia::math::consts::HALF_PI;
    import dkonasov__lygia::math::rotate3dY::rotate3dY;
    @compute @workgroup_size(1)
    fn foo() {
...
test('rotate3dZ', async () => {
  const src = `
    import dkonasov__lygia::math::consts::HALF_PI;
    import dkonasov__lygia::math::rotate3dZ::rotate3dZ;
    @compute @workgroup_size(1)
    fn foo() {
...
test('rotate4d - axis-angle rotation', async () => {
  const src = `
    import dkonasov__lygia::math::consts::HALF_PI;
    import dkonasov__lygia::math::rotate4d::rotate4d;
    @compute @workgroup_size(1)
    fn foo() {
...
test('rotate4dX', async () => {
  const src = `
    import dkonasov__lygia::math::consts::HALF_PI;
    import dkonasov__lygia::math::rotate4dX::rotate4dX;
    @compute @workgroup_size(1)
    fn foo() {
...
test('rotate4dY', async () => {
  const src = `
    import dkonasov__lygia::math::consts::HALF_PI;
    import dkonasov__lygia::math::rotate4dY::rotate4dY;
    @compute @workgroup_size(1)
    fn foo() {
...
test('rotate4dZ', async () => {
  const src = `
    import dkonasov__lygia::math::consts::HALF_PI;
    import dkonasov__lygia::math::rotate4dZ::rotate4dZ;
    @compute @workgroup_size(1)
    fn foo() {
