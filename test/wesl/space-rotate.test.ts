...
test('rotateX3', async () => {
  const src = `
    ...
    import dkonasov__lygia::space::rotateX::rotateX3;
...
test('rotateY3', async () => {
  const src = `
    import dkonasov__lygia::math::consts::HALF_PI;
    import dkonasov__lygia::space::rotateY::rotateY3;
    @compute @workgroup_size(1)
    fn foo() {
...
test('rotateZ3', async () => {
  const src = `
    import dkonasov__lygia::math::consts::HALF_PI;
    import dkonasov__lygia::space::rotateZ::rotateZ3;
    @compute @workgroup_size(1)
    fn foo() {
...
test('rotate', async () => {
  const src = `
    import dkonasov__lygia::math::consts::HALF_PI;
    import dkonasov__lygia::space::rotate::rotate;
    @compute @workgroup_size(1)
    fn foo() {
...
test('rotate_c', async () => {
  const src = `
    import dkonasov__lygia::math::consts::HALF_PI;
    import dkonasov__lygia::space::rotate::rotate_c;
    @compute @workgroup_size(1)
    fn foo() {
...
test('rotate3', async () => {
  const src = `
    import dkonasov__lygia::math::consts::HALF_PI;
    import dkonasov__lygia::space::rotate::rotate3;
    @compute @workgroup_size(1)
    fn foo() {
...
test('bracketing', async () => {
  const src = `
    import dkonasov__lygia::space::bracketing::bracketing;
    import dkonasov__lygia::space::bracketing::BracketingResult;
