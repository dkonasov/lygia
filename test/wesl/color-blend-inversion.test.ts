...
test('blendDifference3', async () => {
  const src = `
     import dkonasov__lygia::color::blend::difference::blendDifference3;
...
test('blendExclusion3', async () => {
  const src = `
     import dkonasov__lygia::color::blend::exclusion::blendExclusion3;
...
test('blendNegation3', async () => {
  const src = `
     import dkonasov__lygia::color::blend::negation::blendNegation3;
...
test('blendPhoenix3', async () => {
  const src = `
     import dkonasov__lygia::color::blend::phoenix::blendPhoenix3;
...
test('blendReflect3', async () => {
  const src = `
     import dkonasov__lygia::color::blend::reflect::blendReflect3;
...
test('blendSubtract3', async () => {
  const src = `
     import dkonasov__lygia::color::blend::subtract::blendSubtract3;
...
test('blendDifference - f32', async () => {
  const src = `
     import dkonasov__lygia::color::blend::difference::blendDifference;
...
test('blendExclusion - f32', async () => {
  const src = `
     import dkonasov__lygia::color::blend::exclusion::blendExclusion;
...
test('blendNegation - f32', async () => {
  const src = `
     import dkonasov__lygia::color::blend::negation::blendNegation;
...
test('blendPhoenix - f32', async () => {
  const src = `
     import dkonasov__lygia::color::blend::phoenix::blendPhoenix;
...
test('blendReflect - f32', async () => {
  const src = `
     import dkonasov__lygia::color::blend::reflect::blendReflect;
...
test('blendSubtract - f32', async () => {
  const src = `
     import dkonasov__lygia::color::blend::subtract::blendSubtract;
