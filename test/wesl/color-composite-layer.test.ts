...
test('layerMultiplySourceOver4', async () => {
  const src = `
    import dkonasov__lygia::color::layer::multiplySourceOver::layerMultiplySourceOver4;
...
test('layerScreenSourceOver4', async () => {
  const src = `
    import dkonasov__lygia::color::layer::screenSourceOver::layerScreenSourceOver4;
...
test('layerAddSourceOver4', async () => {
  const src = `
    import dkonasov__lygia::color::layer::addSourceOver::layerAddSourceOver4;
...
test('layerOverlaySourceOver4', async () => {
  const src = `
    import dkonasov__lygia::color::layer::overlaySourceOver::layerOverlaySourceOver4;
...
test('layerDarkenSourceOver4', async () => {
  const src = `
    import dkonasov__lygia::color::layer::darkenSourceOver::layerDarkenSourceOver4;
...
test('layerLightenSourceOver4', async () => {
  const src = `
    import dkonasov__lygia::color::layer::lightenSourceOver::layerLightenSourceOver4;
...
test('layerDifferenceSourceOver4', async () => {
  const src = `
    import dkonasov__lygia::color::layer::differenceSourceOver::layerDifferenceSourceOver4;
...
test('layerExclusionSourceOver4', async () => {
  const src = `
    import dkonasov__lygia::color::layer::exclusionSourceOver::layerExclusionSourceOver4;
...
test('layerPhoenixSourceOver4', async () => {
  const src = `
    import dkonasov__lygia::color::layer::phoenixSourceOver::layerPhoenixSourceOver4;
...
test('layerSubtractSourceOver4', async () => {
  const src = `
    import dkonasov__lygia::color::layer::subtractSourceOver::layerSubtractSourceOver4;
