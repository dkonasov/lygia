...
test('cubic', async () => {
  const src = `
    import dkonasov__lygia::math::cubic::cubic;
...
test('quartic', async () => {
  const src = `
    import dkonasov__lygia::math::quartic::quartic;
    @compute @workgroup_size(1)
    fn foo() {
...
test('quintic', async () => {
  const src = `
    import dkonasov__lygia::math::quintic::quintic;
    @compute @workgroup_size(1)
    fn foo() {
...
test('invCubic', async () => {
  const src = `
    import dkonasov__lygia::math::invCubic::invCubic;
    import dkonasov__lygia::math::cubic::cubic;
    @compute @workgroup_size(1)
    fn foo() {
...
test('invQuartic', async () => {
  const src = `
    import dkonasov__lygia::math::invQuartic::invQuartic;
    import dkonasov__lygia::math::quartic::quartic;
    @compute @workgroup_size(1)
    fn foo() {
...
test('gain', async () => {
  const src = `
    import dkonasov__lygia::math::gain::gain;
    @compute @workgroup_size(1)
    fn foo() {
...
test('parabola', async () => {
  const src = `
    import dkonasov__lygia::math::parabola::parabola;
    @compute @workgroup_size(1)
    fn foo() {
...
test('gaussian', async () => {
  const src = `
    import dkonasov__lygia::math::gaussian::gaussian;
    @compute @workgroup_size(1)
    fn foo() {
