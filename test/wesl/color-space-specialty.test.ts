...
test('rgb2heat', async () => {
  const src = `
    import dkonasov__lygia::color::space::rgb2heat::rgb2heat;
...
test('cmyk2rgb', async () => {
  const src = `
     import dkonasov__lygia::color::space::cmyk2rgb::cmyk2rgb;
...
test('rgb2cmyk', async () => {
  const src = `
     import dkonasov__lygia::color::space::rgb2cmyk::rgb2cmyk;
...
test('k2rgb - color temperature gradient', async () => {
  const src = `
     import dkonasov__lygia::color::space::k2rgb::k2rgb;
...
test('rgb2lms', async () => {
  const src = `
     import dkonasov__lygia::color::space::rgb2lms::rgb2lms;
...
test('lms2rgb', async () => {
  const src = `
     import dkonasov__lygia::color::space::lms2rgb::lms2rgb;
...
test('lms2rgb4 - alpha preservation', async () => {
  const src = `
     import dkonasov__lygia::color::space::lms2rgb::lms2rgb4;
...
test('rgb2lms4 - alpha preservation', async () => {
  const src = `
     import dkonasov__lygia::color::space::rgb2lms::rgb2lms4;
...
test('rgb2ryb - default mode', async () => {
  const src = `
     import dkonasov__lygia::color::space::rgb2ryb::rgb2ryb;
...
test('rgb2ryb4 - alpha preservation', async () => {
  const src = `
     import dkonasov__lygia::color::space::rgb2ryb::rgb2ryb4;
...
test('ryb2rgb - default mode', async () => {
  const src = `
     import dkonasov__lygia::color::space::ryb2rgb::ryb2rgb;
...
test('ryb2rgb4 - alpha preservation', async () => {
  const src = `
     import dkonasov__lygia::color::space::ryb2rgb::ryb2rgb4;
...
test('rgb2heat4 - vec4 overload with alpha preservation', async () => {
  const src = `
     import dkonasov__lygia::color::space::rgb2heat::rgb2heat4;
