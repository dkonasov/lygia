...
test('sharpenAdaptive - visual', async () => {
  ...
  await lygiaExampleImage(device, 'filter-sharpen-adaptive', {
    ...
    samplers: [sampler],
    shader: `
      import dkonasov__lygia::filter::sharpen::adaptive::sharpenAdaptive;
...
test('sharpenAdaptive4 - visual', async () => {
  ...
  await lygiaExampleImage(device, 'filter-sharpen-adaptive4', {
    ...
    samplers: [sampler],
    shader: `
      import dkonasov__lygia::filter::sharpen::adaptive::sharpenAdaptive4;
...
test('sharpenContrastAdaptive - visual', async () => {
  ...
  await lygiaExampleImage(device, 'filter-sharpen-contrast-adaptive', {
    ...
    samplers: [sampler],
    shader: `
      import dkonasov__lygia::filter::sharpen::adaptive::sharpenContrastAdaptive;
...
test('sharpenFast - visual', async () => {
  ...
  await lygiaExampleImage(device, 'filter-sharpen-fast', {
    ...
    samplers: [sampler],
    shader: `
      import dkonasov__lygia::filter::sharpen::fast::sharpenFast;
...
test('sharpenFast4 - visual', async () => {
  ...
  await lygiaExampleImage(device, 'filter-sharpen-fast4', {
    ...
    samplers: [sampler],
    shader: `
      import dkonasov__lygia::filter::sharpen::fast::sharpenFast4;
...
test('sharpendAdaptiveControl4', async () => {
  const src = `
     import dkonasov__lygia::filter::sharpen::adaptive::sharpendAdaptiveControl4;
